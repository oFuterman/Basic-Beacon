    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Uptime Checks</h1>
                    {total > 0 && (
            ...
            {checks.length === 0 ? (
                <div className="text-center py-16 bg-white rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <h2 className="text-lg font-semibold text-gray-900 mb-2 dark:text-white">No checks yet</h2>
                    <p className="text-gray-600 text-sm max-w-sm mx-auto mb-6 dark:text-gray-400">
                        Get started by creating your first uptime check. Light House will monitor your endpoints and record results automatically.
                    </p>
                    <Link
                        href={`${basePath}/checks/new`}
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition text-sm dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-200"
                    >
                        <svg
                            className="w-4 h-4"
                            fill="none"
                ...
                <div className="bg-white rounded-lg border border-gray-200 overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    {!hasMore && checks.length > 0 && checks.length < total && (
                        <div className="text-center py-4 text-sm text-gray-500 border-t border-gray-100 dark:text-gray-400 dark:border-gray-700">

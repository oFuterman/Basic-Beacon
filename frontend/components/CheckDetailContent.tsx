        ...
        <div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6 dark:bg-gray-800 dark:border-gray-700">
                <div className="flex justify-between items-start mb-4">
                    <div>
                        <h1 className="text-2xl font-bold mb-1 text-gray-900 dark:text-white">{check.name}</h1>
                        <p className="text-gray-600 text-sm dark:text-gray-400">{check.url}</p>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                    <div>
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{check.interval_seconds}s</span>
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="relative">
                    {chartLoading && (
                        <div className="absolute inset-0 bg-white/70 flex items-center justify-center z-10 rounded dark:bg-gray-800/70">

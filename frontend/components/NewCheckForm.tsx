  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    return (
        <div className="max-w-lg mx-auto">
            ...
            <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">New Check</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="name" className="block text-sm font-medium mb-1 text-gray-900 dark:text-gray-200">
                        Name
                    </label>
                    <input
                        id="name"
                ...
                <div>
                    <label htmlFor="url" className="block text-sm font-medium mb-1 text-gray-900 dark:text-gray-200">
                        URL
                    </label>
                    <input
                        id="url"
                ...
                <div>
                    <label htmlFor="interval" className="block text-sm font-medium mb-1 text-gray-900 dark:text-gray-200">
                        Check Interval
                    </label>
                    <select
                        id="interval"
